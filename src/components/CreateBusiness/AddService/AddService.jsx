...
const AddService = ({completeInventory, setCompleteInventory}) => {
		...
		<div className={style.mainContent}>
			<div className={style.formBlock}>
				<form onSubmit={sendDates} className={style.form}>
					<input type={"text"} autoComplete="off" className={`${style.searchInput} ${validMessage.search ? style.invalidInput : ""}`} placeholder={"Enter a service name, field, etc "} value={search} name="search" onChange={onChangeTextInput}/>
					<button type="button" className={style.searchBTN} title="Search"><div className={style.searchIcon}></div></button><br />
					<div className={style.validationText}>{validMessage.search}</div>

					<label htmlFor={"name"}>Name</label><br />
					<input type={"text"} className={validMessage.name ? style.invalidInput : ""} placeholder={"Enter service name"} value={name} name="name" onChange={onChangeTextInput}/><br />
